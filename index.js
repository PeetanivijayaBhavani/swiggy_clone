...
function displayItems(){
    ...
    // filtering the fooddata based on the item-category
...
function addToCart(){
    ...
    if(index=== -1){
        ...
        alert("The item already present in the cart!,if you want same item again (or)remove the item go to the cart");
    }
    //displaying the item numbers like 1,2, ..
